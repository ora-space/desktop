...
Defines the logging registry for the `gitlancer` crate, enabling optional structured logging of git command execution without coupling `gitlancer` to any specific logging framework.

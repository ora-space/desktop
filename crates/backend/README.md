...
Filesystem browsing remains outside this crate. Logging initialization and environment parsing belong to runtime composition roots, while this crate only emits events through shared logging APIs.

...
- `UpdateProjectHandler` changes the project name while preserving its id, repository identity, creation timestamp, and deletion state; the database updates the main Workspace display name in the same write transaction.

...
const translations = {
  "zh-CN": {
    ...
    "chat.suggestion.mockChat": "解释 greeting 的工作方式",
    "chat.suggestion.mockTool": "实现 greeting",
    "chat.suggestion.mockToolWithTests": "实现并测试 greeting",
    "chat.suggestion.mockFailure": "修改不存在的文件",
  ...
  "en-US": {
    ...
    "chat.suggestion.mockChat": "Explain how greeting works",
    "chat.suggestion.mockTool": "Implement greeting",
    "chat.suggestion.mockToolWithTests": "Implement and test greeting",
    "chat.suggestion.mockFailure": "Modify a nonexistent file",

...
const translations = {
  "zh-CN": {
    ...
    "settings.roles.description": "浏览、创建和管理可在 Ora 会话中协作的专业角色。",
    "settings.roles.sectionLabel": "角色目录",
    "settings.roles.catalogHint": "覆盖产品、研发、运维与 AI 场景",
    ...
    "settings.roles.mockFallback": "实时角色暂不可用，当前仍可浏览和编辑本地示例目录。",
    "settings.roles.emptySearchTitle": "没有匹配的角色",
    "settings.roles.emptySearchDescription": "没有找到与“{{query}}”相关的角色，请尝试其他关键词。",
    "settings.roles.mockBadge": "示例",
    "settings.roles.huaweiBadge": "华为场景",
    ...
    "settings.skills.description": "浏览、创建和管理可被角色复用的任务能力。",
    "settings.skills.sectionLabel": "技能目录",
    "settings.skills.catalogHint": "可供不同角色组合使用的任务能力",
    ...
    "settings.skills.mockFallback": "实时技能暂不可用，当前仍可浏览和编辑本地示例目录。",
    "settings.skills.emptySearchTitle": "没有匹配的技能",
    "settings.skills.emptySearchDescription": "没有找到与“{{query}}”相关的技能，请尝试其他关键词。",
    "settings.skills.mockBadge": "示例",
    "settings.skills.huaweiBadge": "华为场景",
  ...
  "en-US": {
    ...
    "settings.roles.description": "Browse, create, and manage specialist roles that can collaborate in Ora sessions.",
    "settings.roles.sectionLabel": "Role catalog",
    "settings.roles.catalogHint": "Product, engineering, operations, and AI",
    ...
    "settings.roles.mockFallback": "Live roles are unavailable. You can still browse and edit the local sample catalog.",
    ...
    "settings.roles.mockBadge": "Sample",
    "settings.roles.huaweiBadge": "Huawei scenario",
    ...
    "settings.skills.description": "Browse, create, and manage reusable capabilities for your roles.",
    "settings.skills.sectionLabel": "Skill catalog",
    "settings.skills.catalogHint": "Reusable capabilities for every role",
    ...
    "settings.skills.mockFallback": "Live skills are unavailable. You can still browse and edit the local sample catalog.",
    ...
    "settings.skills.mockBadge": "Sample",
    "settings.skills.huaweiBadge": "Huawei scenario",

...
export const translationResources = {
  "zh-CN": {
    ...
    "errors.repository_commit_message_blank": "提交信息不能为空。",
    "errors.repository_nothing_staged": "没有已暂存的变更可供提交。",
    "errors.repository_branch_name_blank": "分支名称不能为空。",
    "errors.repository_branch_not_found": "未找到分支 {{branchName}}。",
    "errors.repository_branch_already_exists": "分支 {{branchName}} 已存在。",
    "errors.repository_worktree_dirty": "主工作树有未提交修改，请先提交或暂存后再切换分支。",
    "errors.repository_upstream_not_configured": "当前分支没有配置上游，请先推送并设置 upstream。",
    "errors.repository_sync_not_in_progress": "当前没有正在进行的 merge 或 rebase。",
    ...
    "repository.backToChat": "返回聊天",
    "repository.graph": "提交图谱",
    "repository.changes": "变更",
    "repository.files": "文件",
    "repository.branches": "分支",
    "repository.refresh": "刷新仓库",
    "repository.refreshComingSoon": "仓库刷新功能将在下一步接入",
    "repository.noProject": "请先选择一个项目",
    "repository.noProjectDescription": "仓库工作区使用侧边栏中当前选中的项目。",
    "repository.graphReadyTitle": "仓库图谱工作区已就绪",
    "repository.graphReadyDescription": "已接入项目分支、提交历史、图谱连线和工作树状态。",
    "repository.graphError": "无法加载提交图谱",
    "repository.loadingGraph": "正在加载提交图谱",
    "repository.loadingGraphDescription": "正在读取仓库引用、提交拓扑和工作树状态。",
    "repository.noCommits": "仓库暂无提交",
    "repository.noCommitsDescription": "仓库还没有可展示的提交历史，或当前 HEAD 尚未创建。",
    "repository.selectCommit": "选择一条提交，查看作者、父提交和变更文件。",
    "repository.mergeCommit": "合并提交",
    "repository.author": "作者",
    "repository.committed": "提交时间",
    "repository.parents": "父提交",
    "repository.filesChanged": "变更文件",
    "repository.loadingCommit": "正在读取提交详情…",
    "repository.changedFiles": "变更文件",
    "repository.noChangedFiles": "这条提交没有可展示的文件变更。",
    "repository.openDiff": "查看 Diff",
    "repository.commitDiff": "提交 Diff",
    "repository.noDiff": "这条提交没有可展示的 Diff。",
    "repository.mainChanges": "主工作树变更",
    "repository.mainChangesDescription": "当前项目根仓库的 staged、unstaged 和未跟踪文件。",
    "repository.loadingChanges": "正在读取主工作树变更…",
    "repository.changesError": "无法加载主工作树变更",
    "repository.noWorkingTreeChanges": "主工作树当前没有变更。",
    "repository.untracked": "未跟踪",
    "repository.fetch": "获取远程",
    "repository.fetching": "获取中...",
    "repository.fetchSucceeded": "远程引用已更新。",
    "repository.pull": "拉取",
    "repository.pulling": "拉取中...",
    "repository.pullSucceeded": "已快进同步远程提交。",
    "repository.pullAlreadyUpToDate": "当前分支已经是最新。",
    "repository.pullDivergedTitle": "分支已分叉",
    "repository.pullDivergedDescription": "当前分支领先 {{ahead}} 个提交、落后 {{behind}} 个提交。请选择合并或变基。",
    "repository.merge": "合并",
    "repository.merging": "合并中...",
    "repository.mergeSucceeded": "已通过合并同步远程提交。",
    "repository.rebase": "变基",
    "repository.rebasing": "变基中...",
    "repository.rebaseSucceeded": "已通过变基同步远程提交。",
    "repository.pullConflict": "拉取已暂停：{{operation}}产生了冲突，请处理文件后继续或终止。",
    "repository.syncOperationMerge": "合并冲突",
    "repository.syncOperationRebase": "变基冲突",
    "repository.continueSync": "继续同步",
    "repository.continuingSync": "继续中...",
    "repository.abortSync": "终止同步",
    "repository.abortingSync": "终止中...",
    "repository.syncContinued": "同步已完成。",
    "repository.syncAborted": "已终止同步。",
    "repository.syncConflict": "仍有冲突，请处理后继续。",
    "repository.conflictedFiles": "有 {{count}} 个冲突文件，请在变更面板中处理后继续。",
    "repository.conflictResolution": "冲突解决",
    "repository.conflictDescription": "逐个选择一侧并暂存，全部解决后点击继续同步。",
    "repository.keepCurrent": "保留当前",
    "repository.keepIncoming": "保留传入",
    "repository.keepUpstream": "保留上游",
    "repository.keepLocalCommit": "保留本地提交",
    "repository.conflictResolved": "冲突文件已解决并暂存。",
    "repository.push": "推送",
    "repository.pushing": "推送中...",
    "repository.pushDialogTitle": "推送当前分支？",
    "repository.pushDialogDescription": "将当前分支 {{branch}} 推送到 origin，并设置为上游分支。",
    "repository.pushSucceeded": "当前分支已推送。",
    "repository.changeActions": "变更操作",
    "repository.stageAll": "全部暂存",
    "repository.unstageAll": "全部取消暂存",
    "repository.stage": "暂存",
    "repository.unstage": "取消暂存",
    "repository.stagedChanges": "已暂存变更",
    "repository.unstagedChanges": "未暂存变更",
    "repository.commitMessage": "提交信息",
    "repository.commitMessagePlaceholder": "简要说明这次变更",
    "repository.commit": "提交",
    "repository.committing": "提交中...",
    "repository.commitSucceeded": "仓库变更已提交。",
    "repository.changesUpdated": "变更状态已更新。",
    "repository.selection": "当前选择",
    "repository.selectedWorktree": "当前 Ora 工作树",
    "repository.branch": "分支",
    "repository.selectWorktree": "选择一个工作树，查看它的变更和分支上下文。",
    "repository.localBranches": "本地分支",
    "repository.createBranch": "新建分支",
    "repository.createBranchTitle": "新建本地分支",
    "repository.createBranchDescription": "从当前 HEAD 创建分支，不会自动切换当前工作树。",
    "repository.branchName": "分支名称",
    "repository.branchNamePlaceholder": "例如 feature/repository-workspace",
    "repository.creatingBranch": "正在创建…",
    "repository.checkout": "切换",
    "repository.checkingOut": "切换中…",
    "repository.currentBranch": "当前分支",
    "repository.remoteBranch": "远程",
    "repository.branchCreated": "分支已创建：{{branchName}}",
    "repository.branchCheckedOut": "已切换到：{{branchName}}",
    "repository.branchActionError": "分支操作失败",
    "repository.worktrees": "工作树",
    "repository.loadingBranches": "正在加载分支…",
    "repository.noBranches": "未找到分支",
    "repository.noWorktrees": "暂无 Ora 工作树",
    "repository.managedWorktree": "Ora 管理",
    "repository.branchesError": "无法加载仓库分支",
    "repository.openChanges": "打开变更",
    "repository.noWorktreeSelected": "请选择 Ora 工作树",
    "repository.noWorktreeSelectedDescription": "未选择 Ora 工作树时，这里会显示项目主工作树的变更。",
    "diff.changes": "变更",
  ...
  "en-US": {
    ...
    "errors.repository_branch_name_blank": "Branch name cannot be blank.",
    "errors.repository_branch_not_found": "The branch {{branchName}} was not found.",
    "errors.repository_branch_already_exists": "The branch {{branchName}} already exists.",
    "errors.repository_worktree_dirty": "The main worktree has uncommitted changes. Commit or stash them before switching branches.",
    "errors.repository_upstream_not_configured": "The current branch has no upstream. Push it first and set an upstream branch.",
    "errors.repository_sync_not_in_progress": "There is no active merge or rebase to resolve.",
    "errors.repository_commit_message_blank": "Commit message cannot be blank.",
    "errors.repository_nothing_staged": "There are no staged changes to commit.",
    ...
    "repository.backToChat": "Back to chat",
    "repository.graph": "Graph",
    "repository.changes": "Changes",
    "repository.files": "Files",
    "repository.branches": "Branches",
    "repository.refresh": "Refresh repository",
    "repository.refreshComingSoon": "Repository refresh will be connected next",
    "repository.noProject": "Select a project first",
    "repository.noProjectDescription": "The repository workspace is scoped to the project selected in the sidebar.",
    "repository.graphReadyTitle": "Repository graph workspace is ready",
    "repository.graphReadyDescription": "Project refs, commit history, graph lanes, and worktree status are connected.",
    "repository.graphError": "Unable to load commit graph",
    "repository.loadingGraph": "Loading commit graph",
    "repository.loadingGraphDescription": "Reading repository refs, commit topology, and worktree status.",
    "repository.noCommits": "No commits in this repository",
    "repository.noCommitsDescription": "There is no commit history to display, or HEAD has not been created yet.",
    "repository.selectCommit": "Select a commit to inspect its author, parents, and changed files.",
    "repository.mergeCommit": "Merge commit",
    "repository.author": "Author",
    "repository.committed": "Committed",
    "repository.parents": "Parents",
    "repository.filesChanged": "Changed files",
    "repository.loadingCommit": "Loading commit details...",
    "repository.changedFiles": "Changed files",
    "repository.noChangedFiles": "This commit has no changed files to display.",
    "repository.openDiff": "View diff",
    "repository.commitDiff": "Commit diff",
    "repository.noDiff": "This commit has no diff to display.",
    "repository.mainChanges": "Main worktree changes",
    "repository.mainChangesDescription": "Staged, unstaged, and untracked files in the project repository.",
    "repository.loadingChanges": "Loading main worktree changes...",
    "repository.changesError": "Unable to load main worktree changes",
    "repository.noWorkingTreeChanges": "The main worktree is clean.",
    "repository.untracked": "Untracked",
    "repository.fetch": "Fetch",
    "repository.fetching": "Fetching...",
    "repository.fetchSucceeded": "Remote refs updated.",
    "repository.pull": "Pull",
    "repository.pulling": "Pulling...",
    "repository.pullSucceeded": "Fast-forwarded to the upstream.",
    "repository.pullAlreadyUpToDate": "The current branch is already up to date.",
    "repository.pullDivergedTitle": "Branches have diverged",
    "repository.pullDivergedDescription": "The current branch is {{ahead}} commit(s) ahead and {{behind}} commit(s) behind. Choose merge or rebase.",
    "repository.merge": "Merge",
    "repository.merging": "Merging...",
    "repository.mergeSucceeded": "Merged the upstream into the current branch.",
    "repository.rebase": "Rebase",
    "repository.rebasing": "Rebasing...",
    "repository.rebaseSucceeded": "Rebased the current branch onto the upstream.",
    "repository.pullConflict": "Pull paused: {{operation}} produced conflicts. Resolve the files, then continue or abort.",
    "repository.syncOperationMerge": "Merge conflict",
    "repository.syncOperationRebase": "Rebase conflict",
    "repository.continueSync": "Continue sync",
    "repository.continuingSync": "Continuing...",
    "repository.abortSync": "Abort sync",
    "repository.abortingSync": "Aborting...",
    "repository.syncContinued": "Synchronization completed.",
    "repository.syncAborted": "Synchronization aborted.",
    "repository.syncConflict": "Conflicts remain. Resolve them before continuing.",
    "repository.conflictedFiles": "{{count}} conflicted file(s) need resolution in the Changes panel.",
    "repository.conflictResolution": "Conflict resolution",
    "repository.conflictDescription": "Choose a side and stage each file, then continue synchronization.",
    "repository.keepCurrent": "Keep current",
    "repository.keepIncoming": "Keep incoming",
    "repository.keepUpstream": "Keep upstream",
    "repository.keepLocalCommit": "Keep local commit",
    "repository.conflictResolved": "Conflict file resolved and staged.",
    "repository.push": "Push",
    "repository.pushing": "Pushing...",
    "repository.pushDialogTitle": "Push current branch?",
    "repository.pushDialogDescription": "Push {{branch}} to origin and set it as the upstream branch.",
    "repository.pushSucceeded": "Current branch pushed.",
    "repository.changeActions": "Change actions",
    "repository.stageAll": "Stage all",
    "repository.unstageAll": "Unstage all",
    "repository.stage": "Stage",
    "repository.unstage": "Unstage",
    "repository.stagedChanges": "Staged changes",
    "repository.unstagedChanges": "Unstaged changes",
    "repository.commitMessage": "Commit message",
    "repository.commitMessagePlaceholder": "Summarize these changes",
    "repository.commit": "Commit",
    "repository.committing": "Committing...",
    "repository.commitSucceeded": "Repository changes committed.",
    "repository.changesUpdated": "Changes updated.",
    "repository.selection": "Selection",
    "repository.selectedWorktree": "Selected Ora worktree",
    "repository.branch": "Branch",
    "repository.selectWorktree": "Select a worktree to inspect its changes and branch context.",
    "repository.localBranches": "Local branches",
    "repository.createBranch": "New branch",
    "repository.createBranchTitle": "Create local branch",
    "repository.createBranchDescription": "Create a branch from the current HEAD without switching the current worktree.",
    "repository.branchName": "Branch name",
    "repository.branchNamePlaceholder": "e.g. feature/repository-workspace",
    "repository.creatingBranch": "Creating...",
    "repository.checkout": "Checkout",
    "repository.checkingOut": "Checking out...",
    "repository.currentBranch": "Current branch",
    "repository.remoteBranch": "Remote",
    "repository.branchCreated": "Created branch: {{branchName}}",
    "repository.branchCheckedOut": "Checked out: {{branchName}}",
    "repository.branchActionError": "Branch operation failed",
    "repository.worktrees": "Worktrees",
    "repository.loadingBranches": "Loading branches...",
    "repository.noBranches": "No branches found",
    "repository.noWorktrees": "No Ora worktrees",
    "repository.managedWorktree": "Ora managed",
    "repository.branchesError": "Unable to load repository branches",
    "repository.openChanges": "Open changes",
    "repository.noWorktreeSelected": "Select an Ora worktree",
    "repository.noWorktreeSelectedDescription": "When no Ora worktree is selected, this view shows the project's main worktree changes.",

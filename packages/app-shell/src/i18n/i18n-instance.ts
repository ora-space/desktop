...
const translations = {
  "zh-CN": {
    ...
    "delete.projectDescription": "该项目下所有工作树任务的 Git 工作树、分支和会话都会被删除。未提交修改和仅存在于这些分支的提交可能永久丢失，此操作无法撤销。",
  ...
  "en-US": {
    ...
    "delete.projectDescription": "The Git worktrees, branches, and sessions for every worktree task in this project will be deleted. Uncommitted changes and commits that exist only on those branches may be permanently lost. This cannot be undone.",

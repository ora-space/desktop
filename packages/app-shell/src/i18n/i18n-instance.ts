...
const translations = {
  "zh-CN": {
    ...
    "settings.workflow.deleteWorkflowDescription": "此操作会移除当前工作流，且无法撤销。",
    ...
    "settings.workflow.noSelectionHint": "选择画布中的卡片，或直接运行一次安全预览。",
    ...
    "settings.workflow.field.command": "命令 / Skill",
    "settings.workflow.field.trigger": "触发方式",
    "settings.workflow.field.source": "数据来源",
    "settings.workflow.field.language": "运行语言",
    ...
    "settings.workflow.mockNotice": "安全预览不会执行真实工具",
    ...
    "settings.workflow.kind.trigger": "触发器",
    "settings.workflow.kind.triggerDescription": "手动、定时或 Webhook 启动",
    "settings.workflow.kind.dataSource": "数据来源",
    "settings.workflow.kind.dataSourceDescription": "读取文件、Git 或外部数据",
    "settings.workflow.kind.llm": "LLM",
    "settings.workflow.kind.llmDescription": "调用模型理解和生成内容",
    "settings.workflow.kind.code": "代码",
    "settings.workflow.kind.codeDescription": "执行 Shell、Python 或脚本",
    "settings.workflow.kind.condition": "条件分支",
    "settings.workflow.kind.conditionDescription": "根据规则选择路径",
    "settings.workflow.kind.tool": "工具",
    "settings.workflow.kind.toolDescription": "调用 GitHub 或外部集成",
    "settings.workflow.kind.template": "模板转换",
    "settings.workflow.kind.templateDescription": "用模板重组变量和文本",
    "settings.workflow.kind.output": "输出",
    "settings.workflow.kind.outputDescription": "返回最终结果",
    "settings.workflow.group.input": "输入",
    "settings.workflow.group.process": "处理",
    "settings.workflow.group.output": "结果",
    ...
    "settings.roles.description": "浏览、创建和管理面向代码开发、验证与交付的专业角色。",
    "settings.roles.sectionLabel": "角色目录",
    "settings.roles.catalogHint": "覆盖存储、系统开发、质量与工程效率",
    "settings.roles.resultCount": "显示 {{visible}} / {{total}}",
    "settings.roles.showMore": "再显示 {{count}} 个角色",
    "settings.roles.search": "搜索名称或描述",
    "settings.roles.clearSearch": "清除搜索",
    ...
    "settings.roles.mockFallback": "实时角色暂不可用，当前仍可浏览和编辑内置目录。",
    "settings.roles.emptySearchTitle": "没有匹配的角色",
    "settings.roles.emptySearchDescription": "没有找到与“{{query}}”相关的角色，请尝试其他关键词。",
    "settings.roles.internalBadge": "内部场景",
    "settings.roles.commonLabel": "常用角色",
    "settings.roles.commonHint": "快速进入高频开发任务",
    ...
    "settings.skills.description": "浏览、创建和管理可复用的代码开发、测试与交付能力。",
    "settings.skills.sectionLabel": "技能目录",
    "settings.skills.catalogHint": "覆盖存储验证、代码质量与开源工具链",
    "settings.skills.resultCount": "显示 {{visible}} / {{total}}",
    "settings.skills.showMore": "再显示 {{count}} 个技能",
    "settings.skills.search": "搜索名称或描述",
    "settings.skills.clearSearch": "清除搜索",
    ...
    "settings.skills.mockFallback": "实时技能暂不可用，当前仍可浏览和编辑内置目录。",
    "settings.skills.emptySearchTitle": "没有匹配的技能",
    "settings.skills.emptySearchDescription": "没有找到与“{{query}}”相关的技能，请尝试其他关键词。",
    "settings.skills.internalBadge": "内部场景",
    "settings.skills.commonLabel": "常用技能",
    "settings.skills.commonHint": "快速运行高频工程能力",
    "settings.skills.marketplace": "技能市场",
    "settings.skills.marketplaceRegistry": "Ora Skills Registry",
    "settings.skills.marketplaceTitle": "扩展你的工程能力",
    "settings.skills.marketplaceDescription": "发现经过筛选的开源工具能力，为构建、云原生、可观测性和安全工作流补充专业技能。",
    "settings.skills.marketplaceCurated": "精选开源能力",
    "settings.skills.marketplaceCount": "{{count}} 项可用技能",
    "settings.skills.marketplaceInstant": "即时添加到当前目录",
    "settings.skills.marketplaceSearch": "搜索技能、维护方或能力",
    "settings.skills.marketplaceCategories": "技能市场分类",
    "settings.skills.marketplaceCategory.all": "全部",
    "settings.skills.marketplaceCategory.build": "构建工具",
    "settings.skills.marketplaceCategory.cloud": "云原生",
    "settings.skills.marketplaceCategory.observability": "可观测性",
    "settings.skills.marketplaceCategory.security": "安全",
    "settings.skills.marketplaceCategory.diagnostics": "诊断",
    "settings.skills.marketplaceResults": "{{count}} 项结果",
    "settings.skills.marketplaceFeatured": "精选",
    "settings.skills.marketplaceEmpty": "没有匹配的技能",
    "settings.skills.marketplaceEmptyHint": "尝试其他关键词或切换分类。",
    "settings.skills.install": "添加",
    "settings.skills.installed": "已添加",
    ...
    "settings.plugins.description": "在你常用的工具中与 Ora Agent 协作。安装状态仅在当前会话中保留。",
    ...
    "settings.privacy.description": "控制本地会话记录、诊断数据以及开发数据清理。",
    ...
    "chat.modelSelector.catalog": "Agent 模型",
    "chat.modelSelector.catalogSummary": "{{agents}} 个 Agent",
    "chat.modelSelector.contextWindow": "{{context}} 上下文",
    "chat.modelSelector.capability.recommended": "推荐",
    "chat.modelSelector.capability.coding": "代码",
    "chat.modelSelector.capability.reasoning": "推理",
    "chat.modelSelector.capability.balanced": "均衡",
    "chat.modelSelector.capability.fast": "快速",
    "chat.modelSelector.capability.free": "免费",
    "chat.modelSelector.capability.longContext": "长上下文",
    "chat.modelSelector.capability.multimodal": "多模态",
    "chat.modelSelector.capability.agentic": "Agent",
    "chat.send": "发送消息",
    "chat.starting": "正在启动…",
  ...
  "en-US": {
    ...
    "account.switchChinese": "简体中文",
    "settings.productName": "Ora Agent IDE",
    "settings.prototypeLabel": "Developer settings",
    ...
    "settings.workflow.deleteWorkflowDescription": "This removes the current workflow and cannot be undone.",
    ...
    "settings.workflow.noSelectionHint": "Select a card on the canvas or start a safe preview.",
    ...
    "settings.workflow.field.command": "Command / Skill",
    "settings.workflow.field.trigger": "Trigger type",
    "settings.workflow.field.source": "Data source",
    "settings.workflow.field.language": "Runtime",
    ...
    "settings.workflow.mockNotice": "Safe preview does not execute real tools",
    ...
    "settings.workflow.kind.trigger": "Trigger",
    "settings.workflow.kind.triggerDescription": "Start manually, on schedule, or via webhook",
    "settings.workflow.kind.dataSource": "Data source",
    "settings.workflow.kind.dataSourceDescription": "Read files, Git, or external data",
    "settings.workflow.kind.llm": "LLM",
    "settings.workflow.kind.llmDescription": "Use a model to understand and generate content",
    "settings.workflow.kind.code": "Code",
    "settings.workflow.kind.codeDescription": "Run Shell, Python, or custom scripts",
    ...
    "settings.workflow.kind.toolDescription": "Call GitHub or an external integration",
    "settings.workflow.kind.template": "Template",
    "settings.workflow.kind.templateDescription": "Transform variables and text with a template",
    "settings.workflow.kind.output": "Output",
    "settings.workflow.kind.outputDescription": "Return the final result",
    "settings.workflow.group.input": "Input",
    "settings.workflow.group.process": "Process",
    "settings.workflow.group.output": "Output",
    ...
    "settings.roles.description": "Browse, create, and manage specialist roles for coding, validation, and delivery.",
    "settings.roles.sectionLabel": "Role catalog",
    "settings.roles.catalogHint": "Storage, systems engineering, quality, and developer productivity",
    "settings.roles.resultCount": "Showing {{visible}} of {{total}}",
    "settings.roles.showMore": "Show {{count}} more roles",
    "settings.roles.search": "Search name or description",
    "settings.roles.clearSearch": "Clear search",
    ...
    "settings.roles.mockFallback": "Live roles are unavailable. You can still browse and edit the built-in catalog.",
    "settings.roles.emptySearchTitle": "No matching roles",
    "settings.roles.emptySearchDescription": "No roles match “{{query}}”. Try a different keyword.",
    "settings.roles.internalBadge": "Internal",
    "settings.roles.commonLabel": "Frequently used roles",
    "settings.roles.commonHint": "Quick access to common coding tasks",
    ...
    "settings.skills.description": "Browse, create, and manage reusable capabilities for coding, testing, and delivery.",
    "settings.skills.sectionLabel": "Skill catalog",
    "settings.skills.catalogHint": "Storage validation, code quality, and open-source toolchains",
    "settings.skills.resultCount": "Showing {{visible}} of {{total}}",
    "settings.skills.showMore": "Show {{count}} more skills",
    "settings.skills.search": "Search name or description",
    "settings.skills.clearSearch": "Clear search",
    ...
    "settings.skills.mockFallback": "Live skills are unavailable. You can still browse and edit the built-in catalog.",
    "settings.skills.emptySearchTitle": "No matching skills",
    "settings.skills.emptySearchDescription": "No skills match “{{query}}”. Try a different keyword.",
    "settings.skills.internalBadge": "Internal",
    "settings.skills.commonLabel": "Frequently used skills",
    "settings.skills.commonHint": "Quick access to common engineering capabilities",
    "settings.skills.marketplace": "Skills marketplace",
    "settings.skills.marketplaceRegistry": "Ora Skills Registry",
    "settings.skills.marketplaceTitle": "Extend your engineering capabilities",
    "settings.skills.marketplaceDescription": "Discover curated open-source capabilities for build, cloud-native, observability, and security workflows.",
    "settings.skills.marketplaceCurated": "Curated open-source capabilities",
    "settings.skills.marketplaceCount": "{{count}} skills available",
    "settings.skills.marketplaceInstant": "Add instantly to your catalog",
    "settings.skills.marketplaceSearch": "Search skills, publishers, or capabilities",
    "settings.skills.marketplaceCategories": "Skills marketplace categories",
    "settings.skills.marketplaceCategory.all": "All",
    "settings.skills.marketplaceCategory.build": "Build",
    "settings.skills.marketplaceCategory.cloud": "Cloud native",
    "settings.skills.marketplaceCategory.observability": "Observability",
    "settings.skills.marketplaceCategory.security": "Security",
    "settings.skills.marketplaceCategory.diagnostics": "Diagnostics",
    "settings.skills.marketplaceResults": "{{count}} results",
    "settings.skills.marketplaceFeatured": "Featured",
    "settings.skills.marketplaceEmpty": "No matching skills",
    "settings.skills.marketplaceEmptyHint": "Try another keyword or switch categories.",
    "settings.skills.install": "Add",
    "settings.skills.installed": "Added",
    ...
    "settings.plugins.description": "Work with Ora agents inside the tools you already use. Install state lasts for the current session.",
    ...
    "settings.privacy.description": "Control local conversation records, diagnostics, and development data cleanup.",
    ...
    "chat.modelSelector.catalog": "Agent models",
    "chat.modelSelector.catalogSummary": "{{agents}} Agents",
    "chat.modelSelector.contextWindow": "{{context}} context",
    "chat.modelSelector.capability.recommended": "Recommended",
    "chat.modelSelector.capability.coding": "Coding",
    "chat.modelSelector.capability.reasoning": "Reasoning",
    "chat.modelSelector.capability.balanced": "Balanced",
    "chat.modelSelector.capability.fast": "Fast",
    "chat.modelSelector.capability.free": "Free",
    "chat.modelSelector.capability.longContext": "Long context",
    "chat.modelSelector.capability.multimodal": "Multimodal",
    "chat.modelSelector.capability.agentic": "Agentic",

...
const translations = {
  "zh-CN": {
    ...
    "settings.skills.marketplaceTitle": "技能市场",
    "settings.skills.marketplaceDescription": "浏览精选开源工具能力，并添加到当前技能目录。",
  ...
  "en-US": {
    ...
    "settings.skills.marketplaceTitle": "Skills marketplace",
    "settings.skills.marketplaceDescription": "Browse curated open-source capabilities and add them to your catalog.",

...
const translations = {
  "zh-CN": {
    ...
    "delete.projectDescription": "该项目下的所有任务和会话都会被删除；工作树任务对应的 Git 工作树和 Ora 分支也会被清理。未提交修改和仅存在于这些分支的提交可能永久丢失，此操作无法撤销。",
    "delete.taskDescription": "该任务的 Git 工作树、分支和所有会话都会被删除。未提交修改和仅存在于该分支的提交可能永久丢失，此操作无法撤销。",
    "delete.directTaskDescription": "该任务及其所有会话都会被删除，此操作无法撤销。",
  ...
  "en-US": {
    ...
    "delete.projectDescription": "All tasks and sessions in this project will be deleted. Git worktrees and Ora branches for worktree tasks will also be cleaned up. Uncommitted changes and commits that exist only on those branches may be permanently lost. This cannot be undone.",
    "delete.taskDescription": "This task's Git worktree, branch, and all sessions will be deleted. Uncommitted changes and commits that exist only on that branch may be permanently lost. This cannot be undone.",
    "delete.directTaskDescription": "This task and all of its sessions will be deleted. This cannot be undone.",

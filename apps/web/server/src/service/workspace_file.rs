use ora_contracts::{
    ListProjectDirectoryResponse, ListWorkspaceDirectoryResponse, ReadProjectFileResponse,
    ReadWorkspaceFileResponse, SearchProjectResponse, SearchWorkspaceResponse, WorkspaceEntry,
    WorkspaceEntryKind, WorkspaceSearchKind, WorkspaceSearchResult,
};
use ora_fs::{
